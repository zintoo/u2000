...
class Name:
    ...
    def _map_cxx(self):
        ...
        return list(map(mapID, self._scopedName))
    ...
    def unambiguous(self, environment, cxx = 1):
        ...
        if cxx: relName = list(map(mapID, relName))
    ...
    def guard(self):
        ...
        scopedName = list(map(escapeChars, self._scopedName[:]))
